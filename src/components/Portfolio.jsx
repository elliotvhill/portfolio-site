                    ...
                    <div className='card shadow-sm'>
                        ...
                        <div className='card-body'>
                            ...
                            <p className='card-text'>
                                Web app built with vanilla Javascript that uses
                                RESTful Axios API calls to pull images from
                                NASA's Mars Curiosity Rover Photos API.
                            </p>
                            <p className='card-text'>
                                <a
                    ...
                    <div className='card shadow-sm'>
                        ...
                        <div className='card-body'>
                            ...
                            <p className='card-text'>
                                ...
                                implemented using MongoDB and Mongoose.The app
                                allows users to track concerts they've attended,
                                including artists, venues, and setlists.
                            </p>
                            <p className='card-text'>
                                <a
                ...
                <div className='col-sm-12 col-md-6 col-lg-4 mb-3 mb-sm-0'>
                    <div className='card shadow-sm'>
                        ...
                        <div className='card-body'>
                            ...
                            <p className='card-text'>
                                Full stack MERN app built with OpenAI's DALL-E
                                API that generates images based on text prompts.
                            </p>
                            <p className='card-text'>
                                <a
